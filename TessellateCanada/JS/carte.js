...
var nbLargeur = 10; // il indiquer le nombre de cases en longueur + 2

var r = (width/(nbLargeur*Math.sqrt(3)));
	
// Echelle X : le range a été mis "a la main" pour que les états soient assez espacé
var xRange = function(x) {
	return (x+1)*(width/nbLargeur); // il faut diviser par le nombre de cases en longueur + 2
}
...
//Dessin des hexagones en parcourant la carte
g.selectAll("path")
